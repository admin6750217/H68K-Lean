...
UPDATE_PACKAGE "luci-app-homeproxy" "immortalwrt/homeproxy" "master" "name" "homeproxy"
...
UPDATE_PACKAGE "luci-app-openclash" "vernesong/OpenClash" "master" "name" "openclash"
